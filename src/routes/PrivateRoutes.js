  ...
  return (
    <Suspense>
      <Switch>
        ...
        <Route exact path={links.bridge} render={() => <div>Bridge coming soon!</div>} />
        <Route exact path={links.lending} render={() => <div>Lending coming soon!</div>} />
        ...
        />
        <Route exact path={links.vote} render={() => <div>Vote coming soon!</div>} />
        <Route exact path={links.docs} render={() => <div>Docs coming soon!</div>} />
