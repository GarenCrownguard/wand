import icon1swap from "./icon-1swap";
import icon2usdt from "./icon-2usdt";
import icon3busd from "./icon-3busd";
import icon4usdc from "./icon-4usdc";
...
export {
  ...
  icon2usdt as IconTokenUSDT,
  icon3busd as IconTokenBUSD,
